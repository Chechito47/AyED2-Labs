...
void test_head() {
    ...
    struct head_testcase tests[N_TESTCASES_HEAD] = {
      ...
      { {0, 0, 0}, 3, 0 },      // testea: head([0, 0, 0]) == 0
      { {1, 2, 3, 4}, 4, 1 },   // testea: head([1, 2, 3, 4]) == 1
    };
...
void test_index() {
    ...
    struct index_testcase tests[N_TESTCASES_INDEX] = {
      ...
      { {1, 1, -2}, 3, 2, -2 },     // testea: index([8, 1, -2], 2) == -2
      { {1}, 1, 0, 1 },             // testea: index([1], 0) == 1
      { {1, 2, 3, 4}, 4, 3, 4 },    // testea: index([1, 2, 3, 4], 3) == 3
    };
...
void test_length() {
    ...
    struct length_testcase tests[N_TESTCASES_LENGTH] = {
      ...
      { {1, 2, 3, 4, 5}, 5 },// testea: length([1, 2, 3, 4, 5]) == 5
      { {1, 2, 3, 4}, 4 },  // testea: length([1, 2, 3, 4]) == 4
    };
