...
/*
    The code was not working because now original is a pointer and we where
    passing sizeof(original) / sizeof(*original) as length. Now we cant use
    it beceause it't a pointer so we should use string_length so it has to
    be added at top.
*/