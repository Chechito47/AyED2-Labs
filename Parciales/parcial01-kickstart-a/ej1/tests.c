...
int main(void) {
    struct testcase tests[N_TESTCASES] = {
        ...
        { 3, {blue, red, white}, {red, white, blue} },
        { 4, {blue, red, red, white}, {red, red, white, blue} },
        { 4, {blue, red, white, white}, {red, white, white, blue} },
        { 5, {blue, blue, red, red, white}, {red, red, white, blue, blue} },
